...
def main() -> None:
    ...
    if args.predictions:
        oos[[
            "race_id", "date", "venue", "umaban", "field_size",
            "finish_pos", "is_win", "is_place", "win_odds", "popularity",
            "tan_payout", "place_payout", "p_win", "p_place",
            "rank_score", "rank_model", "rank_win", "rank_place",
            "rank_market", "rank_to_win_probability",
